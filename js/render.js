...
var Render = (function () {
  ...
  /* Silhouetten der Figuren: dunkler Aufsatz auf farbigem Schaft, Füße auf y = 0.
     ...
     ein Turm mit Zinnen, eine Axt, eine schräge Klinge, ein Pferdekopf, ein
     Schild, ein Bogen samt Pfeil, eine Raute – und für den Zenturio der
     Helm mit dem Querbusch, an dem man den Zenturio bei den Römern erkannt hat.
  ...
  var HEADS = {
    ...
    // Arbeiter: Axt – Stiel mit quer sitzendem Blatt, die Schneide nach links.
    // Er ist der Einzige, der Bäume fällt.
    worker:    'M-2,-11 L-2,-25 L2,-25 L2,-11 Z ' +
               'M-10,-31.5 C-5,-29.5 -1,-29 3,-29 L8,-29 L8,-23.5 L3,-23.5 ' +
               'C-1,-23.5 -5,-23 -10,-21 Z',
    ...
    // Bogenschütze: Bogen mit aufgelegtem Pfeil
    archer:    'M2,-30 C9,-25.5 9,-14.5 2,-10 L-0.8,-11.6 ' +
               'C5,-15.4 5,-24.6 -0.8,-28.4 Z ' +
               'M-4.5,-21 L4,-21 L4,-19 L-4.5,-19 Z ' +
               'M-9.5,-20 L-4,-23.4 L-4,-16.6 Z',
    // Tangolin: Raute – der einzige gleichmäßige Vierecker
    tangolin:  'M0,-30 L8.5,-20.5 L0,-11 L-8.5,-20.5 Z',
    // Zenturio: Helm mit gezacktem Querbusch, an dem man ihn bei den Römern
    // erkannte – ein Umriss, die höchste und breiteste Figur im Spiel
    zenturio:  'M-9.5,-11 L-8.5,-16 C-8,-20.5 -6,-22.5 -4,-23.5 ' +
               'L-5.5,-30 L-2,-31.5 L0,-28.5 L2,-31.5 L5.5,-30 L4,-23.5 ' +
               'C6,-22.5 8,-20.5 8.5,-16 L9.5,-11 Z'
  };
  ...
  function pieceGlyph(g, cam, o, cx, cy, z, piece, color, k) {
    ...
    stand.appendChild(el('rect', {
      class: 'piece-stem', x: -4.2, y: -14, width: 8.4, height: 13, rx: 1.8, fill: color
    }));
  ...
  function pieceIcon(type, color) {
    ...
    return '<svg class="piece-icon" viewBox="-26 -26 52 52" aria-hidden="true">' +
      ...
      '<rect class="piece-stem" x="-4.2" y="-14" width="8.4" height="13" rx="1.8" fill="' + color + '"/>' +
